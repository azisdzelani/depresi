...
<head>
  <meta charset="utf-8">
  <title>KMS:: <?= $this->template->title; ?></title>
      ...
      <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
          <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
            class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="<?php echo base_url('dashboard') ?>">Sistem Manajemen Pengetahuan </a>
        ...
        <div class="subnavbar-inner">
          <div class="container">
            <ul class="mainnav">
              ...
              <li><a href="<?=base_url('dokumen/user_view');?>"><i class="icon-book"></i><span>Dokumentasi</span></a></li>
              <!-- end menu dokumen -->
              ...
              <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-calendar"></i><span>Report</span> <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#">Laporan Pengetahuan</a></li>
